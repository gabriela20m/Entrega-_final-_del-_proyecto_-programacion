  ...
  while (!fechasValidas) {
    ...
    if (fechaValida(anio1, mes1, dia1, anioMin, mesMin, diaMin, anioMax, mesMax,
        ...
        fechaExiste(anio2, mes2, dia2, datos,
                    numDatos)) { // Verifica que la fecha sea valida en el rango
...
void registrarUsuario(Usuario usuarios[], int &numUsuarios,
  ...
  cout << "Ingrese nombre de usuario (correo electrónico): ";
...
int menuDatosMeteorologicos() {
  ...
  cout << endl << endl << "Ingrese su opción: ";
  cin >> opcion;
  cout << endl;
...
bool continuarPrograma() {
  char respuesta;
  while (true) {
    cout << endl << "¿Desea seguir operando? (s/n): ";
    cin >> respuesta;
    ...
    case 1:
      if (iniciarSesion(usuarios, numUsuarios)) {
        ...
        do {
          ...
          default: {
            cout << endl << "OPCIÓN INVÁLIDA - INTENTELO DE NUEVO" << endl;
            break;
          }
          }
